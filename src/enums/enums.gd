...
var ScenePaths = {
	...
	Scenes.SWAMP_DRY_TRAIL: "res://src/scenes/swamp/trail_on_solid_ground/trail_on_solid_ground.tscn",
	...
	Scenes.SWAMP_RIDGE: "res://src/scenes/swamp/bramble_ridge/bramble_ridge.tscn",
